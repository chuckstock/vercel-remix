...
hoistedDependencies:
  ...
  /@remix-run/eslint-config/1.15.0_rollmblchzatnd6ayiciecrhqe:
  ...
  /@sentry/node/7.50.0:
    '@sentry/node': private
  /@sentry/react/7.50.0_react@18.2.0:
    '@sentry/react': private
  /@sentry/remix/7.50.0_3jeblurgf54sp7ixdlsqt3kp4y:
  ...
  /eslint-import-resolver-typescript/3.5.5_yz7bfxpeccpe7w3ay66jwrvqnq:
    eslint-import-resolver-typescript: public
  /eslint-module-utils/2.8.0_kfaezdl56442ighgsth3u3y2wi:
    eslint-module-utils: public
  /eslint-plugin-es/3.0.1_eslint@8.39.0:
    eslint-plugin-es: public
  /eslint-plugin-import/2.27.5_ayqt4qstu5keqxlc7um2afgqqm:
    eslint-plugin-import: public
  /eslint-plugin-jest-dom/4.0.3_eslint@8.39.0:
    eslint-plugin-jest-dom: public
  /eslint-plugin-jest/26.9.0_y3iptfnunkio26ivoamoftqpfq:
  ...
  /remix-island/0.1.2_kyj3lvbdqgbfhl474nt3vob5tu:
